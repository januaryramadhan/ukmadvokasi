...
import { Wrench, Clock, ArrowLeft, FileText, Mail, Phone, Home } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-red-100">
              Pusat dokumentasi dan panduan {ORGANIZATION_INFO.shortName}
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden mb-8">
              <div className="bg-gradient-to-r from-orange-50 to-yellow-50 px-8 py-12 text-center border-b border-gray-200">
                ...
                <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                  Halaman dokumentasi sedang dalam proses pengembangan dan pemeliharaan. 
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      ...
                      <li>• Galeri foto dan video kegiatan</li>
                    </ul>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">Fitur Upload</span>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              ...
              >
                ...
                <h3 className="font-semibold text-gray-900 mb-2">Galeri Kegiatan</h3>
                <p className="text-sm text-gray-600">
                  Lihat dokumentasi foto dan video kegiatan UKM Advokasi
                </p>
              </Link>
